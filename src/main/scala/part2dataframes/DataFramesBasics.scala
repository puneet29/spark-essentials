...
object DataFramesBasics extends App {
  ...
  println(carsDFSchema) // returns StructType for firstDF
  ...
  val manualCarsDF = spark.createDataFrame(cars) // schema auto-inferred // gives _1, _2 ... names to the columns

  // Note: DataFrames have schemas. Rows do not have schemas
